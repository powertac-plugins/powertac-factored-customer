 ...
 *
 */
class FactoredCustomerModel extends AbstractCustomer
{
	...
	{
		log.info "possibilityEvaluationNewTariffs() begin - ${toString()}, timeslot: ${timeService.currentTime}"
		if (subscriptions == null || subscriptions.size() == 0) {
			subscribeDefault()
			return
		}
		else handleNewTariffs(newTariffs)
		log.info "possibilityEvaluationNewTariffs() end - ${toString()}, timeslot: ${timeService.currentTime}"
	}
